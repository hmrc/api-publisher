...
class MicroserviceConnectorSpec extends AsyncHmrcSpec with BeforeAndAfterAll with GuiceOneAppPerSuite {
  ...
  "getAPIDefinition" should {
    ...
    "return DefinitionFileFailedSchemaValidation if the API definition has whitelistedApplicationIds" in new Setup {
      ...
      // Due to the non-determinism in the reporting of the two validations in anyOf we have to look for either of the orders
      val expectedErrors = List(
        DefinitionFileFailedSchemaValidation(Json.parse("""{"schemaLocation":"#/properties/api/properties/versions/items","pointerToViolation":"#/api/versions/0","causingExceptions":[{"schemaLocation":"#/properties/api/properties/versions/items/properties/access","pointerToViolation":"#/api/versions/0/access","causingExceptions":[{"schemaLocation":"#/properties/api/properties/versions/items/properties/access/anyOf/1","pointerToViolation":"#/api/versions/0/access","causingExceptions":[{"pointerToViolation":"#/api/versions/0/access","causingExceptions":[],"keyword":"enum","message":"{\"whitelistedApplicationIds\":[\"76327c12-17fa-4a51-8a8b-23f7251fae1b\",\"76327c12-17fa-4a51-8a8b-23f7251fae1a\"],\"type\":\"PRIVATE\"} is not a valid enum value"},{"pointerToViolation":"#/api/versions/0/access","causingExceptions":[],"keyword":"type","message":"expected type: String, found: JSONObject"}],"keyword":"allOf","message":"#: only 0 subschema matches out of 2"},{"schemaLocation":"#/properties/api/properties/versions/items/properties/access/anyOf/0","pointerToViolation":"#/api/versions/0/access","causingExceptions":[],"keyword":"additionalProperties","message":"extraneous key [whitelistedApplicationIds] is not permitted"}],"keyword":"anyOf","message":"#: no subschema matched out of the total 2 subschemas"}],"keyword":"allOf","message":"#: only 1 subschema matches out of 2"}""")),
        DefinitionFileFailedSchemaValidation(Json.parse("""{"schemaLocation":"#/properties/api/properties/versions/items","pointerToViolation":"#/api/versions/0","causingExceptions":[{"schemaLocation":"#/properties/api/properties/versions/items/properties/access","pointerToViolation":"#/api/versions/0/access","causingExceptions":[{"schemaLocation":"#/properties/api/properties/versions/items/properties/access/anyOf/1","pointerToViolation":"#/api/versions/0/access","causingExceptions":[{"pointerToViolation":"#/api/versions/0/access","causingExceptions":[],"keyword":"type","message":"expected type: String, found: JSONObject"},{"pointerToViolation":"#/api/versions/0/access","causingExceptions":[],"keyword":"enum","message":"{\"whitelistedApplicationIds\":[\"76327c12-17fa-4a51-8a8b-23f7251fae1b\",\"76327c12-17fa-4a51-8a8b-23f7251fae1a\"],\"type\":\"PRIVATE\"} is not a valid enum value"}],"keyword":"allOf","message":"#: only 0 subschema matches out of 2"},{"schemaLocation":"#/properties/api/properties/versions/items/properties/access/anyOf/0","pointerToViolation":"#/api/versions/0/access","causingExceptions":[],"keyword":"additionalProperties","message":"extraneous key [whitelistedApplicationIds] is not permitted"}],"keyword":"anyOf","message":"#: no subschema matched out of the total 2 subschemas"}],"keyword":"allOf","message":"#: only 1 subschema matches out of 2"}"""))
      )
      expectedErrors should contain(result)
    }
